  ...
  - class: InitialWorkDirRequirement
    listing:
      ...
      - entryname: taxonomy.xml
        entry: "${\n  protein_fasta = inputs.protein_fasta.basename\n  data = \"<?xml version=\\\"1.0\\\"?> \\n\" +\n    \"<bioml label=\\\"x! taxon-to-file matching list\\\"> \\n\" + \n    \"\t<taxon label=\\\"\" + inputs.prot_taxon + \"\\\">\" + \"\\n\" +\n      \"\t\t<file format=\\\"peptide\\\" URL=\\\"\" + protein_fasta + \"\\\"/>\" + \"\\n\" +\n    \"\t</taxon> \\n\" +\n    \"</bioml> \"\n  \n  return data\n}"
      - entryname: input.xml
        entry: |-
          ${
            input_spectra = inputs.input_spectra.basename
            input_spectra_ext = input_spectra.split('.')[input_spectra.split('.').length-1]
            input_spectra_name = input_spectra.substring(0, input_spectra.indexOf(input_spectra_ext)-1)
            list_path = inputs.list_path_default_parameters.basename
            data = "<?xml version=\"1.0\"?> \n" +
              "<bioml> \n" + 
